...
RcppExport SEXP _BNR_fitOLS(SEXP ySEXP, SEXP XSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _BNR_tr(SEXP ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _BNR_MMP(SEXP ASEXP, SEXP BSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd> >::type A(ASEXP);
...
RcppExport SEXP _BNR_matIP(SEXP ASEXP, SEXP BSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd> >::type A(ASEXP);
...
RcppExport SEXP _BNR_matInv(SEXP ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd> >::type A(ASEXP);
...
RcppExport SEXP _BNR_det(SEXP ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd> >::type A(ASEXP);
...
RcppExport SEXP _BNR_matOP(SEXP XSEXP, SEXP YSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd> >::type X(XSEXP);
...
RcppExport SEXP _BNR_matQF(SEXP XSEXP, SEXP ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd> >::type X(XSEXP);
...
RcppExport SEXP _BNR_SchurC(SEXP IbbSEXP, SEXP IaaSEXP, SEXP IbaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_BNR_fitOLS", (DL_FUNC) &_BNR_fitOLS, 2},
    {"_BNR_tr", (DL_FUNC) &_BNR_tr, 1},
    {"_BNR_MMP", (DL_FUNC) &_BNR_MMP, 2},
    {"_BNR_matIP", (DL_FUNC) &_BNR_matIP, 2},
    {"_BNR_matInv", (DL_FUNC) &_BNR_matInv, 1},
    {"_BNR_det", (DL_FUNC) &_BNR_det, 1},
    {"_BNR_matOP", (DL_FUNC) &_BNR_matOP, 2},
    {"_BNR_matQF", (DL_FUNC) &_BNR_matQF, 2},
    {"_BNR_SchurC", (DL_FUNC) &_BNR_SchurC, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_BNR(DllInfo *dll) {
